...
RUN pip install matplotlib==3.7 tikzplotlib jpeg4py opencv-python lmdb pandas scipy loguru shapely
...
COPY checkpoints/checkpoint.pt ${APP_ROOT}/checkpoints/sam2.1_hiera_base_plus.pt
